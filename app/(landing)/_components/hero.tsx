...
const TechSlider = () => {
  const icons = [siEthereum, siNextdotjs, siReact, siShadcnui, siWagmi, siEthers, siSolidity];
  return (
        ...
        <div className='relative pt-24'>
          <div className='mx-auto max-w-7xl px-6'>
            <div className='text-center sm:mx-auto lg:mr-auto lg:mt-0'>
              <AnimatedLink href='#link' text='Get your documents on-chain' />
              <h1 className='mt-8 text-6xl lg:mt-16'>
                Trust Chain: On-Chain Proof. Off-Chain Trust.
              </h1>
              <p className='mx-auto mt-6 max-w-3xl text-base'>
                Blockchain-powered document store, where you can register, verify, and secure credentials with zero chance of tampering.
              </p>
              <CTAButtons />
            </div>
          </div>
